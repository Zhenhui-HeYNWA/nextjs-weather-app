...
function DailyForecast() {
  ...
  return (
    ...
    gap-8 dark:bg-dark-grey shadow-sm dark:shadow-none col-span-full sm:col-span-2 md:col-span-2 xl:col-span-2 md:hover:scale-105 transition-all ease-in-out hover:shadow-xl hover:bg-gray-50'>
